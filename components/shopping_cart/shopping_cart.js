module.exports = {
    ...
    shoppingCartListModel: function () {
        var self = this.currentPage;
        var carGoods = self.carGoods;
        var shoppingCartModel = self.shoppingCartModel;
    ...
    clearShoppingCart: function (self) {
        var self = this.currentPage;
        var quickHots = self.quick_hot_goods_lists;
    ...
    saveItemData: function (self) {
        var item = {
            ...
            'carGoods': self.carGoods,
            'total': self.total,
            'quick_hot_goods_lists': self.quick_hot_goods_lists,
            'checked_attr': self.checked_attr
        }
        uni.setStorageSync(self.getApp().const.ITEM, item)
    },
    ...
    goodNumChange: function (e) {
        ...
        var goodId = e.target.dataset.id ? parseInt(e.target.dataset.id) : self.currentGood.id;
        var carGoods = self.carGoods;
        var quickList = self.quick_list;
        var quickHotList = self.quick_hot_goods_lists;
